...
gulp.task('watch', function() {
  ...
  gulp.watch('./www/*.*',['compile']);
  gulp.watch('./www/partial/*.*',['compile']);
  gulp.watch('./www/css/*.css',['compile']);
  gulp.watch('./www/js/*.*',['compile']);
});
...
gulp.task('sass', shell.task([
  'sass --watch ./www/css/*.scss --style compact'
  ]));

gulp.task('deploy', shell.task([
    'git subtree push --prefix www/out origin gh-pages'    
]));
...
gulp.task('compile', ['compileHTML', 'compileCSS', 'compileJS']);
...
gulp.task('compileCSS', function () {
     return gulp.src('./www/css/*.css')
        .pipe(gulp.dest('./www/out/css'));
});

gulp.task('compileJS', function () {
     return gulp.src('./www/js/*.js')
        .pipe(gulp.dest('./www/out/js'));
});